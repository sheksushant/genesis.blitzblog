...
define( 'CHILD_THEME_NAME', __( 'BlitzBlog Theme', 'BlitzBlog' ) );
define( 'CHILD_THEME_URL', 'http://www.futurebink.com/blitzblog' );
...
add_theme_support( 'genesis-style-selector', array(
	'BlitzBlog-blue'		=> 'Blue',
	'BlitzBlog-green'	=> 'Green',
	'BlitzBlog-black'	=> 'Black',
	'BlitzBlog-white'		=> 'Hybrid',
) );
...
function footer_output_filter( $output, $backtotop_text, $creds_text ) {
    $creds_text = '<p>Copyright [footer_copyright] - <a href="'. trailingslashit( get_bloginfo('url') ) .'" title="'. esc_attr( get_bloginfo('name') ) .'" rel="dofollow">'.get_bloginfo('name').'</a>';
	  ...
	  $output = '<div class="gototop"> [footer_backtotop text="Return to Top" href="#"] </div>' . '<div class="creds">' . $creds_text . ' | Crafted by <a href="http://www.github.com/sushantshekhar20">@sushantshekhar20</a> from <a href="http://www.futureblink.com">FutureBlink</a> </p></div>' ;
      return $output;
}
